      ...
      {agent?.role ? (
          ...
          >
            ...
            for efficiency */}
                {agent?.role === "SUPERVISOR"
                  ? "Manage your agents dynamically, leveraging real-time insights for efficiency"
                  : "Manage your tasks as an agent dynamically, leveraging real-time insights for efficiency"}
              </p>
              {agent?.role === "SUPERVISOR" ? (
                <>
        ...
        <div className="flex h-screen w-screen justify-center items-center">
          <div className=" justify-center  items-center flex flex-col">
            <img src="/images/S2C Figma7 Logo.svg" className=" w-32 h-auto" />
            <h4 className=" py-10 text-3xl font-extralight text-blue-800 ">
              Summit Service & Consulting
            </h4>

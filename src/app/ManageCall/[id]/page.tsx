      ...
      <div className="flex flex-col flex-1 p-10 ml-20">
        <Flex direction="column" gap="2rem">
          ...
          <div className="flex">
            ...
            {agent?.needsHelp && (
              <div className=" bg-red-500 rounded-full py-2 px-3 font-bold text-white justify-center items-center flex ml-5 text-xs">
                <p>Asking for help</p>
              </div>
            )}
          </div>
        ...
        <Flex direction="row" style={{ flex: 1 }}>
          ...
          <Popover>
            <PopoverTrigger
              ...
              onClick={async () => {
                if (isOnCall?.id && role?.arn) {
                  ...
                  console.log("AllowedMonitorCapabilities: ", [
                    "SILENT_MONITOR",
                    "BARGE",
                  ]);
                  console.log(
                    "InstanceId: ",
                    "96cb63e2-25a1-4014-8f3c-e3919415d597"
                  );

                  const params = {
                    ContactId: isOnCall.id, // Asumimos que isOnCall?.id existe basado en el if
                    UserId: userId,
                    AllowedMonitorCapabilities: JSON.stringify([
                      "SILENT_MONITOR",
                      "BARGE",
                    ]),
            ...
            >
              <FontAwesomeIcon
                icon={faPhone}
                size="3x"
                color={`${isOnCall ? "green" : "darkblue"}`}
              />

              <Text className="mt-10" fontWeight="bold">
                {isOnCall ? "Monitor Call" : ""}
              </Text>
            </PopoverTrigger>
            {isPopoverVisible && (
              <PopoverContent
                                  ...
                                  <div className=" px-10 py-2">
                                    ...
                                    <div className="flex items-center">
                                      <h3
                                        ...
                                        style={{
                                          color:
                                            getSentimentColor(agentSentiment)
                                              .color,
                                        }}
                                      >
          ...
          <div className=" flex  h-[85%] w-96 flex-col justify-center items-center">
            ...
            >
              <div className="flex flex-col gap-2 h-[600px] overflow-y-scroll no-scrollbar w-[400px]">
                {transcript &&

...
exports.handler = async (event) => {
    ...
    try {
        const resCreateContact = await createContact(phone, contactID, callStart, agentUsername);
        ...
        console.error(`Error creating contact or setting user as in call: ${error}`);
        return {
            statusCode: 500,
            body: JSON.stringify(`Error creating contact or setting user as in call: ${error}`),
        };
    }
};
